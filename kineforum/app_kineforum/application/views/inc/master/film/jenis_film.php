        ...
        <div class="col-sm-12" id="daftar">
  				<table id="table-master-jenis-film" class="table table-bordered">
  					<thead>
                <tr>
                  <th>No.</th>
                  <th>Jenis Film</th>
      ...
      <?php $this->load->view('inc/master/film/jenis_film_modal') ?>
      ...
      <script type="text/javascript" src="<?php echo $this->config->item('url_app_kineforum') ?>js/modules/master/film/jenis_film.js"></script>